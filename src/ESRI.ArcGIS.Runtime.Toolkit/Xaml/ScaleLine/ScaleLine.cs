...
namespace ESRI.ArcGIS.Runtime.Toolkit.Xaml
{
    ...
    public class ScaleLine : Control
    {
        ...
        {
            return LinearUnit.Inch.ConvertTo(((TargetWidth) / 96) * Scale, LinearUnit.Kilometer);            
        }
        ...
        {
            return LinearUnit.Inch.ConvertTo(((TargetWidth) / 96) * Scale, LinearUnit.Meter);            
        }
        ...
        {
            return LinearUnit.Inch.ConvertTo(((TargetWidth) / 96) * Scale, LinearUnit.Mile);            
        }
        ...
        {
            return LinearUnit.Inch.ConvertTo(((TargetWidth) / 96) * Scale, LinearUnit.Foot);            
        }
