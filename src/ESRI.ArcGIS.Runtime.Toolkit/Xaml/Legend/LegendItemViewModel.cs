...
namespace ESRI.ArcGIS.Runtime.Toolkit.Xaml.Primitives
{
	/// <summary>
	...
	public class LegendItemViewModel : INotifyPropertyChanged
	{
		...
		public ImageSource SymbolSwatch
		{
			get
			{
				...
				if (_swatch == null)
				{
					if(_symbol is IMarkerSymbol)
						_swatch = new SymbolSwatchImageSource(_symbol as IMarkerSymbol, DisplayProperties.LogicalDpi);
					else
						_swatch = new SymbolSwatchImageSource(15, 15, _symbol, DisplayProperties.LogicalDpi);
				}
				return _swatch;
			}
		}
